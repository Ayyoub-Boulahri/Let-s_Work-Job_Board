...
function CompaniesList(props) {
    ...
    useEffect(() => {
        const getCompanies = async () => {
            try {
                getSomeCompanies({
                    ...
                    "founded_year": 1,
                    "size": 1,
                }, (currentPage - 1) * companyPerPage, companyPerPage, props.searchTxt, props.filters).then(response => {
        ...
        const getNumCompanies = async () => {
            getTotalCompanies(props.searchTxt, props.filters).then(response => {
        ...
        getNumCompanies()
        getCompanies()
    }, [currentPage, props.searchTxt, props.filters])
