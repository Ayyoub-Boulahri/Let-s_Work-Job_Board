...
import { removeEmployeeJobPostulation } from '../../services/jobOfferServices';

function DeletePostulationModel(props) {
                    ...
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody className="popupModel">
                                Are you sure you want to remove your job Postulation ?
                            </ModalBody>
                            <ModalFooter>
...
export default DeletePostulationModel